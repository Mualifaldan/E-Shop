      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-12 my-md-4 text-center">
            <h1 class="h3 text-gray-800 font-weight-bold">Manajemen Barang</h1>
            <hr>
          </div>
          <div class="col-12">
            <div class="card shadow mb-4">
              <div class="card-header py-3">
                <div class="row align-items-center">
                  <div class="col-10">
                    <span class="m-0 font-weight-bold text-primary">Data Barang</span>
                  </div>
                      ...
                      @foreach ($menus as $menu)
                        <tr>
                          ...
                          <td>
                            ...
                            <img src="{{ Storage::url($menu->img) }}" alt="menu image" width="100">
                          </td>
                          <td>
                            @if ($menu->status == 0)
