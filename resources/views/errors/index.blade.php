...
@section('header')
  ...
  <title>
    {{ $errors->first('type') }} ERROR - E-Shop
  </title>
          ...
          <div class="col-12">
            <div class="card shadow">
              <div class="card-body text-center">
                <span class="display-1 font-weight-bold font-italic">{{ $errors->first('type') }}</span>
                <br>
                <span class="font-weight-bold">Error: {{ $errors->first('message') }}</span>
                <br>
                <br>
